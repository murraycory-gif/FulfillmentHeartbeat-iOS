...
final class HeartbeatMathTests: XCTestCase {
    ...
    func testArchitecture428PickPathStoreExpandListsJoinedShoppers() throws {
        XCTAssertEqual(BuildStamp.id, "HB-0828.469")
    ...
    /// HB-0828.469: iPad Regions/Markets rows fill the card. Leftover width is an
    /// even gutter once columns hit a snug cap, so Pick Path ORDERS is not a canyon
    /// and Sales does not leave a dead zone after Status. Phone cards stay put.
    ...
    func testArchitecture468LiveSqliteOverStaleFacts() throws {
        ...
        XCTAssertTrue(PulseLiveSource.shouldIgnoreOlderFactsStamp(factsStamp: "HB-0828.419", packStamp: "HB-0828.469"))
        XCTAssertFalse(PulseLiveSource.shouldIgnoreOlderFactsStamp(factsStamp: "HB-0828.469", packStamp: "HB-0828.419"))
