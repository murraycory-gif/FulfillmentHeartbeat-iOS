...
final class HeartbeatMathTests: XCTestCase {
    ...
    /// HB-0828.470: iPad Regions/Markets rows fill the card. Leftover width is an
    ...
    func testArchitecture468LiveSqliteOverStaleFacts() throws {
        ...
        XCTAssertTrue(PulseLiveSource.shouldIgnoreOlderFactsStamp(factsStamp: "HB-0828.419", packStamp: "HB-0828.470"))
        XCTAssertFalse(PulseLiveSource.shouldIgnoreOlderFactsStamp(factsStamp: "HB-0828.470", packStamp: "HB-0828.419"))
