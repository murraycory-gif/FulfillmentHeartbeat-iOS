...
final class HeartbeatMathTests: XCTestCase {
    ...
    func testArchitecture428PickPathStoreExpandListsJoinedShoppers() throws {
        XCTAssertEqual(BuildStamp.id, "HB-0828.472")
    ...
    /// Pack chrome skips picker_scorecard. Opening PPH must rebuild the index.
    /// A division seat with shoppers must not summarize as No data.
    func testArchitecture470PPHIndexSurvivesPackChromeAndDivisionSeat() {
        XCTAssertEqual(BuildStamp.id, "HB-0828.472")
        XCTAssertTrue(PulseLaunch.shouldLoadPickerScorecardForPPHIndex(
            section: .pph, indexBuckets: 0, indexedShoppers: 0, packShoppers: 100
        ))
        XCTAssertTrue(PulseLaunch.shouldLoadPickerScorecardForPPHIndex(
            section: .pph, indexBuckets: 2, indexedShoppers: 77, packShoppers: 100
        ))
        XCTAssertFalse(PulseLaunch.shouldLoadPickerScorecardForPPHIndex(
            section: .pph, indexBuckets: 4, indexedShoppers: 100, packShoppers: 100
        ))
        XCTAssertFalse(PulseLaunch.shouldLoadPickerScorecardForPPHIndex(
            section: .sales, indexBuckets: 0, indexedShoppers: 0, packShoppers: 100
        ))
    ...
    /// HB-0828.472: iPad Regions/Markets rows fill the card. Leftover width is an
    ...
    func testArchitecture468LiveSqliteOverStaleFacts() throws {
        ...
        XCTAssertTrue(PulseLiveSource.shouldIgnoreOlderFactsStamp(factsStamp: "HB-0828.419", packStamp: "HB-0828.472"))
        XCTAssertFalse(PulseLiveSource.shouldIgnoreOlderFactsStamp(factsStamp: "HB-0828.472", packStamp: "HB-0828.419"))
