...
final class HeartbeatMathTests: XCTestCase {
    ...
    func testArchitecture428PickPathStoreExpandListsJoinedShoppers() throws {
        XCTAssertEqual(BuildStamp.id, "HB-0828.471")
    ...
    /// HB-0828.471: iPad Regions/Markets rows fill the card. Leftover width is an
    ...
    func testArchitecture468LiveSqliteOverStaleFacts() throws {
        ...
        XCTAssertTrue(PulseLiveSource.shouldIgnoreOlderFactsStamp(factsStamp: "HB-0828.419", packStamp: "HB-0828.471"))
        XCTAssertFalse(PulseLiveSource.shouldIgnoreOlderFactsStamp(factsStamp: "HB-0828.471", packStamp: "HB-0828.419"))
