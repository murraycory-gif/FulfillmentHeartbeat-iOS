...
final class HeartbeatMathTests: XCTestCase {
    ...
    func testArchitecture428PickPathStoreExpandListsJoinedShoppers() throws {
        XCTAssertEqual(BuildStamp.id, "HB-0828.457")
    ...
    func testArchitecture427MacCatalystHasAppCategory() throws {
        ...
        if FileManager.default.fileExists(atPath: plistURL.path) {
            ...
            XCTAssertTrue(pbx.contains("CURRENT_PROJECT_VERSION = 776;"))
        }
    ...
    func testArchitecture457DashboardNestsThisWeekDetail() {
        ...
        XCTAssertTrue(home.contains("PhoneCompanyThisWeekBlock(section: card.section)"), home)
        XCTAssertTrue(home.contains("usesMetricFactStoreCount: true"), home)
        XCTAssertTrue(home.contains("shouldShowDashboardThisWeekDetail()"), home)
        XCTAssertTrue(
            command.contains("chips: CommandCenterLayout.phoneScorecardChips(painted)"),
            "RESULT chips stay on the dashboard hero"
        )
