...
final class HeartbeatMathTests: XCTestCase {
    ...
    func testArchitecture428PickPathStoreExpandListsJoinedShoppers() throws {
        XCTAssertEqual(BuildStamp.id, "HB-0828.464")
    ...
    func testLaunchDoesNotRefetchTheSameLocalPack() {
        ...
        XCTAssertEqual(urls.first?.absoluteString, "\(PulseCloud.defaultPackHost)/current.sqlite")
    ...
    func testArchitecture427MacCatalystHasAppCategory() throws {
        ...
        if FileManager.default.fileExists(atPath: plistURL.path) {
            ...
            XCTAssertTrue(pbx.contains("CURRENT_PROJECT_VERSION = 783;"))
        }
