...
final class HeartbeatMathTests: XCTestCase {
    ...
    func testArchitecture428PickPathStoreExpandListsJoinedShoppers() throws {
        XCTAssertEqual(BuildStamp.id, "HB-0828.470")
    ...
    func testArchitecture468LiveSqliteOverStaleFacts() throws {
        ...
        XCTAssertTrue(PulseLiveSource.shouldIgnoreOlderFactsStamp(factsStamp: "HB-0828.419", packStamp: "HB-0828.468"))
        XCTAssertFalse(PulseLiveSource.shouldIgnoreOlderFactsStamp(factsStamp: "HB-0828.468", packStamp: "HB-0828.419"))
