...
final class HeartbeatMathTests: XCTestCase {
    ...
    func testArchitecture428PickPathStoreExpandListsJoinedShoppers() throws {
        XCTAssertEqual(BuildStamp.id, "HB-0828.461")
    ...
    func testArchitecture427MacCatalystHasAppCategory() throws {
        ...
        if FileManager.default.fileExists(atPath: plistURL.path) {
            ...
            XCTAssertTrue(pbx.contains("CURRENT_PROJECT_VERSION = 780;"))
        }
    ...
    func testArchitecture457DashboardNestsThisWeekDetail() {
        ...
        XCTAssertTrue(home.contains("PhoneThisWeekChrome.chips("), home)
        XCTAssertTrue(home.contains("shouldShowDashboardThisWeekDetail()"), home)
        XCTAssertTrue(home.contains("phoneScorecardChips(painted)"), home)
    ...
    func testArchitecture458DashboardMergesResultAndPaintsFilterSeat() {
        ...
        XCTAssertTrue(block.contains("dashboardSeatCard("), block)
        XCTAssertTrue(block.contains("shouldMergeDashboardResultAndThisWeek()"), block)
        XCTAssertTrue(block.contains("PhoneThisWeekChrome.chips("), block)
        XCTAssertTrue(block.contains("phoneScorecardChips(painted)"), block)
