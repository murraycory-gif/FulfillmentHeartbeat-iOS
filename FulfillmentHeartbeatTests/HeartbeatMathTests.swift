...
final class HeartbeatMathTests: XCTestCase {
    ...
    func testArchitecture381SeatPackContract() {
        XCTAssertEqual(BuildStamp.id, "HB-0828.416")
    ...
    /// Soft FAIL a7822f6: NSSharingService unavailable on Mac Catalyst.
    /// Mail path is MFMailCompose only. FILE ROOT MUST 1–5 stand.
