...
final class HeartbeatMathTests: XCTestCase {
    ...
    func testArchitecture428PickPathStoreExpandListsJoinedShoppers() throws {
        XCTAssertEqual(BuildStamp.id, "HB-0828.447")
    ...
    func testArchitecture446PhoneHeroesUseLaborScorecardChrome() {
        ...
        XCTAssertTrue(
            brand?.contains("title: compactBannerTitle") == true
                && brand?.contains("subtitle: compactBannerSubtitle") == true,
            "Operational Heartbeat phone banner must use scorecard chrome"
        )
        XCTAssertFalse(
    ...
    func testArchitecture447CompactPageBannerIsNotScorecardRow() {
        ...
        guard let brand,
              ...
              let end = brand.range(of: "private var compactBannerSubtitle")
        else {
        ...
        XCTAssertTrue(banner.contains("compactBannerTitle"), banner)
        XCTAssertTrue(banner.contains("compactBannerSubtitle"), banner)
