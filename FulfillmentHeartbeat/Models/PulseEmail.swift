...
enum PulseMail {
    ...
    private static func html(_ snap: Snapshot) -> String {
        ...
        .page{background:#fff;border:2.5px solid #3A69EA;border-radius:16px;overflow:hidden;margin:0 0 18px}
        .banner{background:#3A69EA;color:#fff;padding:12px 16px;font-weight:700;font-size:18px}
