# HB-0828.412 / 738 — verify (Mac bottom callouts not clipped)

**Tip** `origin/cursor/command-center-8b-3389` · [PR #5](https://github.com/murraycory-gif/FulfillmentHeartbeat-iOS/pull/5)
**Stamp** `HB-0828.412  1.0 (738)` · bundle `com.corymurray.FulfillmentHeartbeat`
**No TestFlight until this PASSes.** HARD TF HOLD. Do not delete the app. Cloud Linux cannot `xcodebuild` or talk to a Mac/iPad (no self-hosted worker registered). 412 keeps Prep + sidebar stamp above the window/dock.
...
| Check | Pass |
|---|---|
| Sidebar stamp | `HB-0828.412  1.0 (738)` — fully visible, not under the dock / window edge |
...
| Automated test | `testArchitecture412MacBottomCalloutsVisible` + 411/410/408 Soft KEEP green |
...
1. Confirm stamp **HB-0828.412  1.0 (738)**. Pages stays on phone. No phone Back chevron. Tighter CC / section cards.
