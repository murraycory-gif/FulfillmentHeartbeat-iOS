# HB-0828.467 / 786 — verify (shopper filters on Store / Ops / District / Division)

**Tip** `cursor/mac-catalyst-category-70dd` off `cursor/mac-share-attach-1006` (`300eb83`)
**Stamp** `HB-0828.467  1.0 (786)` · bundle `com.corymurray.FulfillmentHeartbeat`
...
| Check | Pass |
|---|---|
| Sidebar stamp | `HB-0828.467  1.0 (786)` |
