# HB-0828.472 / 787 — verify (pickers under filters + even iPad scorecard columns; live sqlite Sales, not stale facts.json)

**Tip** `cursor/mac-catalyst-category-70dd` off `cursor/mac-share-attach-1006` (`300eb83`)
**Stamp** `HB-0828.472  1.0 (787)` · bundle `com.corymurray.FulfillmentHeartbeat`
...
| Check | Pass |
|---|---|
| Sidebar stamp | `HB-0828.472  1.0 (787)` |
