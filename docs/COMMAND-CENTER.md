...
| Mac | **Collapsible** left Pages rail + window-fit center (xxxLarge Dynamic Type + MacReadable metric atoms). No top Pages button. Hide pages expands the center; resize reflows heroes / glance / callouts so nothing clips the bottom edge. Never phone D1–D5 shrink. Picker Top Opportunity keeps column headers (MUST H). **No right Alerts column.** |
