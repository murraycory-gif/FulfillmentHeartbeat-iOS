...
| Mac | **Pinned** left Pages rail + **readable** center (xxxLarge Dynamic Type + MacReadable metric atoms on every section table / chip / filter). Never phone D1–D5 shrink, even in a compact Catalyst window. Picker Top Opportunity keeps column headers (MUST H). **No right Alerts column.** |
