...
Stamp **HB-0828.386  1.0 (712)**. UDID `676FA816-88AE-59D9-A89D-5C17BFC2DA96`. Force-quit first. No TF until every line is PASS.
...
6. iPad stays cool; dashboard scroll snappy. Stamp **HB-0828.386  1.0 (712)**. Mac: Pages + center only — **no Alerts rail**.
...
11. Section scorecards: store table **only** in District / OM / Store. Company + Region = rollup only.
