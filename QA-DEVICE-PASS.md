...
Stamp **HB-0828.385  1.0 (711)**. UDID `676FA816-88AE-59D9-A89D-5C17BFC2DA96`. Force-quit first. No TF until every line is PASS.
...
6. iPad stays cool; dashboard scroll snappy. Stamp **HB-0828.385  1.0 (711)**.
7. Missing seat object (airplane / unpublished grain) **fails** the hub — does not invent a pack from `current.sqlite`.
8. Command Center: 3 navy heroes + real glance tiles. Mac: pinned Pages + Alerts. iPad land/port: **full-width center**; Pages / Alerts open as drawers only.
