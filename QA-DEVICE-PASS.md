...
Stamp **HB-0828.390  1.0 (716)**. UDID `676FA816-88AE-59D9-A89D-5C17BFC2DA96`. Force-quit first. No TF until every line is PASS. **Recook + republish first** — tip alone does not heal OM_AREA baked into existing sqlite.
...
6. iPad stays cool; dashboard scroll snappy. Stamp **HB-0828.390  1.0 (716)**. Mac + iPad: **no Alerts rail / pop-out**. Glance tiles: **blue title banner**, bigger title, **centered** health-tinted icon — no spark bars. No Dashboard back chevron. District (and OM / Store) section pages: **exactly one** "Store · N stores · tap to expand" — never two stacked.
